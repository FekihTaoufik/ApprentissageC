...
int popBuffer(FILE *f,node_t ** head,node_t ** bhead, double *busyTime,double *residenceTime, double *waitingTime,double currentTime);								// Remove the waiting event at the front of the buffer
